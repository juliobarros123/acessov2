                                                    ...
                                                    <ol type="a">
                                                        @foreach (alineas_geradas()->where('alinea_geradas.it_id_pergunta', $pergunta->id)->get() as $alinea)
                                                            <li style="list-style: none">
                                                                {{ $alinea->alinea }}){{ banco_alinea($alinea->it_id_banco_alinea)->description }}
                                                                @if ($respostas->where('it_id_pergunta', $pergunta->id)->where('it_id_banco_alinea', $alinea->it_id_banco_alinea)->count())
                                                                    @php
